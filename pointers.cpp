            ...
            return doubleInput;
                ...
                while (checked != 1) {
                    ...
                    if (stringInput.size() > 0) {
                        //if string not empty ensure entry is valid numbers
                        int i = 0;
                        while(i < stringInput.size()) {
                            if (isdigit(stringInput[i]) == false && stringInput[i] != '.') {
                                i = 0;
                                printf("%s\n", "char here");
                                std::cout << "Sorry, I cannot understand your answer";
                                std::cout << "\n";
                ...
                //input has been checked for no numerical now check for min/max issues
                printf("%s\n", "double here");
                doubleInput = std::stod(stringInput); 
